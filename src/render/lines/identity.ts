...
const DEBUG =
  process.env.DEBUG?.includes("claude-statusline") || process.env.DEBUG === "*";
...
export function renderIdentityLine(
  ...
  if (DEBUG && autocompactMode === "disabled") {
    console.error(
      `[claude-statusline:context] autocompactBuffer=disabled, showing raw ${rawPercent}% (buffered would be ${bufferedPercent}%)`,
    );
  }
