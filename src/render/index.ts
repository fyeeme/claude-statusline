...
import { isCjkAmbiguousWide } from './width.js';
import { visualLength, stripAnsi, segmentGraphemes, graphemeWidth } from './measure.js';

// Local ANSI patterns still used by sliceVisible / truncateToWidth / splitLineBySeparators.
